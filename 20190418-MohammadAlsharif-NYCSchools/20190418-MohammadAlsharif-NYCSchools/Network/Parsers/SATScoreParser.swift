...
import UIKit
// This class will parse the FetchScore API response
class SATScoreParser: ParserBase {
    ...
    override func parseData(data:  Any) -> AnyObject? {
        ...
        for scoreData in scoreList {
            ...
            score.score_num_of_sat_test_takers = scoreData["num_of_sat_test_takers"] as? String
            ...
            response.scoreDetails.append(score)
        }
